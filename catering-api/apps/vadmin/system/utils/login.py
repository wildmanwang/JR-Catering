...
from apps.vadmin.system.crud import MenuDal, UserDal
from apps.vadmin.system.models import VadminUser
...
async def api_login_for_access_token(
    ...
    await VadminLoginRecord.create_login_record(db, record, True, request, resp, user_id=user.id, user_name=user.name)
    return resp
...
async def login_for_access_token(
    ...
    try:
        ...
        await VadminLoginRecord.create_login_record(
            db, data, True, request, resp, 
