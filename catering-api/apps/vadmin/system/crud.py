...
from sqlalchemy import update, select, false, and_
...
class CompanyDal(DalBase):

    def __init__(self, db: AsyncSession):
        super(CompanyDal, self).__init__()
        self.db = db
        self.model = models.Company
        self.schema = schemas.CompanySimpleOut


class BranchDal(DalBase):

    def __init__(self, db: AsyncSession):
        super(BranchDal, self).__init__()
        self.db = db
        self.model = models.Branch
        self.schema = schemas.BranchSimpleOut
