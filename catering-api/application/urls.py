...
from apps.vadmin.system.utils.login import app as auth_app
from apps.vadmin.system.views import app as vadmin_auth_app
...
from apps.vadmin.product.views import app as vadmin_product_app
...
urlpatterns = [
    ...
    {"ApiRouter": vadmin_product_app, "prefix": "/vadmin/product", "tags": ["产品管理"]},
]
